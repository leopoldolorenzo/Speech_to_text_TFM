# generar_dataset_finetune_01.py
# Prepara un DatasetDict HuggingFace desde un TSV generado con muestras .wav convertidas
...
# === Rutas ===
DIR_BASE = "data/common_voice_es/es/fine_tune_01"
TSV_IN = os.path.join(DIR_BASE, "dataset_30k.tsv")
