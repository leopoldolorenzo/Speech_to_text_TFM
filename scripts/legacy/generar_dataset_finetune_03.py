# generar_dataset_finetune_03.py
# Prepara un DatasetDict HuggingFace desde un TSV generado con muestras .wav convertidas (fine_tune_03)
...
TSV_IN = os.path.join(DIR_BASE, "dataset_200.tsv")
