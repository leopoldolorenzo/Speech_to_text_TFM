# generar_dataset_finetune_04.py
# Prepara un DatasetDict HuggingFace desde un TSV generado con muestras .wav convertidas (fine_tune_04)
...
# === Rutas ===
DIR_BASE = "data/common_voice_es/es/fine_tune_04"
TSV_IN = os.path.join(DIR_BASE, "dataset_200k.tsv") 
